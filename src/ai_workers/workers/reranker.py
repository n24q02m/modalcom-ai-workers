...
class RerankerLightServer:
    ...
    def load_model(self) -> None:
        ...
        self.yes_token_id = self.tokenizer.convert_tokens_to_ids("yes")  # ty:ignore[possibly-missing-attribute]
        self.no_token_id = self.tokenizer.convert_tokens_to_ids("no")  # ty:ignore[possibly-missing-attribute]
    ...
    def _score_pair(self, query: str, document: str) -> float:
        ...
        input_text = self.tokenizer.apply_chat_template(  # ty:ignore[possibly-missing-attribute]
            messages, tokenize=False, add_generation_prompt=True
        )
        inputs = self.tokenizer(input_text, return_tensors="pt").to(self.model.device)  # ty:ignore[call-non-callable]
