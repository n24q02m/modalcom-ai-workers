...
class VLRerankerServer:
    ...
    def _score_pair(
        ...
        if query_image_url:
            ...
            if image_cache and query_image_url in image_cache:
        ...
        if document_image_url:
            ...
            if image_cache and document_image_url in image_cache:
    ...
    def serve(self):
        ...
        async def rerank(body: VLRerankRequest = Body(...)):
            ...
            # Deduplicate image URLs to prevent redundant fetching
            ...
            if unique_image_urls:
                ...
                fetched = await asyncio.gather(*(fetch_image(url) for url in unique_image_urls))
                image_cache = dict(fetched)
