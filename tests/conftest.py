...
@pytest.fixture(autouse=True)
def _reset_auth_keys() -> None:
    """Reset the module-level valid keys cache in auth middleware.

    This ensures that each test gets a fresh set of valid keys based on
    its specific environment variables setup.
    """
